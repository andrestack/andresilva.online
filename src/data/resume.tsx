...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/andrestack",
        icon: Icons.github,
      ...
      X: {
        name: "Email",
        url: "mailto:mail@andresilva.online",
        icon: Icons.email,
  ...
  work: [
    {
      ...
      description:
        "I have been working with local businesses to help them get their online presence up and running: from simple landing pages, to fullstack dashboards and CRM implementation.",
    },
    {
      company: "Prevess AI",
      badges: [],
      href: "https://prevess.com",
      location: "Remote",
      ...
      description:
        "Worked on improving UI elements for better user experience and performance. Created custome components for the admin dashboard including i18n, dark mode and more.",
    },
    {
      company: "Expath",
      href: "https://expath.com",
      badges: [],
      location: "Remote",
  ...
  education: [
    ...
    {
      school: "Power MBA",
      href: "https://www.thepowermba.com/en",
      degree: "Digital MBA",
      logoUrl: "/mba.png",
      start: "2020",
      end: "2022",
    },
    {
      ...
      degree: "Master's Degree in German Teaching",
      logoUrl: "/fu.png",
      start: "2010",
      end: "2012",
    },
  ...
  projects: [
    {
      title: "Astral Logbook",
      href: "https://logbook.astral.global/",
      dates: "Sep 2024",
      active: true,
      description:
        "Contributed to Astral Logbook, an open-source decentralized application built on Astral's Location Proof Protocol. I implemented error handling logic and micro-improved some aspects of the UI",
      technologies: [
        "Next.js",
        "Typescript",
        "React Suspense",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/AstralProtocol/logbook",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
      video:
        "https://assets.andresilva.online/astral_logbook.mp4",
    },
    {
      ...
      active: true,
      description:
        "A simple random activity generator that allows users to generate a random activity to do with their kids.",
      technologies: [
        "Vanilla JS",
      ],
      // links: [
